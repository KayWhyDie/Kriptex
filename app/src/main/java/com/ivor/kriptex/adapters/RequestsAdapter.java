...
public class RequestsAdapter extends RealmRecyclerViewAdapter<Contact, RequestViewHolder> {
    ...
    public RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.accept.setOnClickListener(v -> {
            ...
            // Update using a Realm-managed instance from the transaction's Realm.
            // This ensures the query-backed RealmResults actually changes and triggers UI refresh.
            String address = contact.getAddress();
            Contact.acceptContact(mContext, address);
            Client.getInstance(mContext).startAskForNewMessages(address);
        });
